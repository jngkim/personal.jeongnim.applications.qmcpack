...
#SBATCH --job-name=c1025.m1025.prq76
...
#########################################################
#
# batch script with compilers 20221025 
# OMP interop returns SYCL::queue 
#
#########################################################

cdir=`pwd`
app=/home/jeongnim/applications.hpc.workloads.aurora.qmcpack/hpval-env/qmcpack_gpu_c1025m1025/bin/qmcpack
...
#DO NOT USE SYCL IMMEDIATE COMMAND LIST
